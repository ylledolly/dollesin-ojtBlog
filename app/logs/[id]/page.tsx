  ...
  return (
    <section className="min-h-screen bg-[#0a0a0a] text-white py-20 px-6 md:px-12 lg:px-20">
      <div className="max-w-5xl mx-auto">
        ...
        <h1 className="mt-10 font-serif text-6xl tracking-tight">
          {entry.title}
        </h1>
        ...
        <div className="mt-12">
          ...
          {entry.images.length === 0 ? (
            <div className="rounded-2xl border-2 border-zinc-800 bg-zinc-900/50 p-12 text-zinc-400 text-center italic">
